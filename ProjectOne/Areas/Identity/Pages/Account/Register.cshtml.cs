...
namespace ProjectFuse.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<ProjectOneUser> _userStore;
        ...
        private ProjectOneUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<ProjectOneUser>();
            }
            catch
            {
        ...
        private IUserEmailStore<ProjectOneUser> GetEmailStore()
        {
